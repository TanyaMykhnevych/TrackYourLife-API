...
namespace DataLayer.Migrations
{
    ...
    [Migration("20171008104513_DonorRequest_DonorInfoIsRequired")]
    partial class DonorRequest_DonorInfoIsRequired
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Entities.PatientQueueItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("PatientUserInfoId");
            ...
            modelBuilder.Entity("DataLayer.Entities.PatientQueueItem", b =>
                {
                    ...
                    b.HasOne("DataLayer.Entities.OrganQueries.PatientOrganQuery", "PatientOrganQuery")
                        .WithMany()
                        .HasForeignKey("PatientOrganQueryId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DataLayer.Entities.UserInfo", "PatientUserInfo")
                        .WithMany()
                        .HasForeignKey("PatientUserInfoId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
